...
class StorageWrapper {
	...
	public getBool(key: string) {
		...
		const boolLower = bool?.toLowerCase(); // https://www.w3schools.com/js/tryit.asp?filename=tryjs_boolean
		return boolLower ? Boolean(boolLower === 'false' ? 0 : boolLower) : undefined;
	}
